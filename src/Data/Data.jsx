...
const heroapi = {
  ...
  sociallinks: [
    { icon: facebook, url: "https://www.instagram.com/my_name_is_sc_/" },
    { icon: messenger, url: "https://www.instagram.com/my_name_is_sc_/" },
    { icon: instagram, url: "https://www.instagram.com/my_name_is_sc_/" },
    { icon: twitter, url: "https://twitter.com/33_souvik/" },
